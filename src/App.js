      ...
      <section id="about" className="py-32 px-8 md:px-24 relative z-10">
        <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col md:flex-row gap-16 items-center">
          <motion.div variants={itemVariants} className="w-full md:w-1/3">
            <img src={ajPhoto} alt="AJ Rayamajhi" className="rounded-2xl w-full max-w-sm mx-auto object-cover shadow-2xl shadow-[#6366F1]/20" />
          </motion.div>
          <div className="w-full md:w-2/3">
            ...
            <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-black mb-6">
              Nepal to Texas to Minnesota.<br />
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
              {['Java', 'Python', 'React', 'Spring Boot', 'PostgreSQL', 'Gemini AI', 'Git'].map((skill) => (
                <span key={skill} className="bg-[#1E293B] text-[#6366F1] px-4 py-2 rounded-lg text-sm font-semibold">{skill}</span>
              ))}
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <motion.div key={project.title} variants={itemVariants} className="bg-[#0F1120] border border-white/5 rounded-2xl p-8 hover:border-[#6366F1]/50 transition group">
      ...
      <section id="contact" className="py-32 px-8 md:px-24 relative z-10">
        <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center max-w-2xl mx-auto">
          ...
          <motion.div variants={itemVariants} className="flex justify-center gap-4 flex-wrap">
            <a href="mailto:rayamajhi.anirudra@gmail.com" className="bg-[#6366F1] hover:bg-[#5558DD] text-white px-8 py-3 rounded-lg font-semibold transition">Email Me</a>
            <a href="https://linkedin.com/in/anirudra-rayamajhi-bb48b83b4" target="_blank" rel="noreferrer" className="border border-white/20 hover:border-white/50 text-white px-8 py-3 rounded-lg font-semibold transition">LinkedIn</a>
            <a href="https://github.com/rayamajhianirudra-droid" target="_blank" rel="noreferrer" className="border border-white/20 hover:border-white/50 text-white px-8 py-3 rounded-lg font-semibold transition">GitHub</a>
          </motion.div>
        </motion.div>
      </section>
